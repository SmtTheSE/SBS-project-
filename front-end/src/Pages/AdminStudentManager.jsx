  ...
  const toggleAccountStatus = async (student) => {
    try {
      ...
      if (response.ok) {
        ...
        alert('Failed to update account status: ' + errorText);
      }
    } catch (error) {
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-lg p-6 mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <h4 className="text-lg font-semibold text-gray-700 border-b pb-2">Account Information</h4>
              ...
              {/* Address Information */}
              <div className="space-y-4">
                <h4 className="text-lg font-semibold text-gray-700 border-b pb-2">Address Information</h4>
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">Ward ID</label>
                    <input
                      type="text"
              ...
              <table className="min-w-full bg-white border border-gray-200">
                <thead>
                  <tr className="bg-gray-100">
                    ...
                    <th className="py-2 px-4 border-b text-left">Account Status</th>
                ...
                <tbody>
                  {students.map((student) => (
                    <tr key={student.studentId} className="hover:bg-gray-50">
                      ...
                      <td className="py-2 px-4 border-b">{getGenderText(student.gender)}</td>
                      <td className="py-2 px-4 border-b">{student.nationality}</td>
                      <td className="py-2 px-4 border-b">{student.cityId}</td>
                          ...
                          <button
                            onClick={() => {
                              ...
                              setEditData({
                                ...
                                wardName: '', // 初始化区域名称字段
                                accountStatus: student.loginAccount ? student.loginAccount.accountStatus : 1,
                                password: '' // 初始化密码字段
                              });
                            }}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-700 mb-1">Study Plan ID</label>
                          <input
                            type="text"
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        {/* Account Information */}
                        <h4 className="text-lg font-semibold text-gray-700 mt-4 mb-3">Account Information</h4>
